...
# Utils
import joblib 
pipe_lr = joblib.load(open("D:/AI Projects/NLP SENTIMENT ANALYSIS/finall.pkl","rb"))
...
emotions_emoji_dict = {1: "Positive 😂", 2: "Neutral 😐", 3: "Negative 😔" ,0: "Negative 😔" }
...
def main():
	...
	if choice == "Home":
		...
		if submit_text:
			...
			# Apply Fxn Here
			emotions_emoji_dict = {1: "Positive 😂", 2: "Neutral 😐", 3: "Negative 😔" }
